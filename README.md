...
[![Build Status](https://img.shields.io/github/checks-status/notsatan/crcgen/master?color=black&style=for-the-badge&logo=github)][github-actions]
[![Code Coverage](https://img.shields.io/codecov/c/github/notsatan/crcgen?color=blue&logo=codecov&style=for-the-badge)][github-actions-tests]
...
[![License](https://img.shields.io/github/license/notsatan/crcgen?color=red&style=for-the-badge)][project-license]
...
This section will guide you to setup a fully-functional local copy of `crcgen`
...
from [`crcgen's` Makefile][makefile-file] (most of which are
OS-independent)!

### Installing dependencies

To install all dependencies associated with `crcgen`, run the
command
...
The pre-commit hooks used by `crcgen` are located within the
...
Tests in `crcgen` are classified as *fast* and *slow* - depending
...
To run `crcgen` in a docker container, read the instructions in
...
`crcgen` is powered by a template generated using [`go-template`][go-template-link]
